...
system.time(
  data_hs6 <- lapply(years, function(x){
    ...
    # read imports data
    imports <- data.table(read_fst(paste0(datadir,"HS2/Import_",x,".fst")))
    ...
    # read exports data
    exports <- data.table(read_fst(paste0(datadir,"HS2/Export_",x,".fst")))
...
data_f_mismatch[, trade.value.mismatch.residual := trade.value.mismatch - trade.value.mismatch.costs - (trade.value.mismatch.extreme.p - trade.value.mismatch.extreme.p.costs) - trade.value.mismatch.tariff]
...
wb_reg <- data.table(read.csv(here("data","wb regions.csv"), header=T, stringsAsFactors = F))
...
wb_inc <- data.table(read.csv(here("data","wb income grouping.csv"), header=T, stringsAsFactors = F))
...
write.csv(data_final, file=here("output","Reported trade gap decomposition 2010-2015 tariff.csv"), row.names = F)
...
cpal <- c("#e41a1c","#377eb8","#4daf4a","#984ea3","#ff7f00","#ffe033","#333333")
...
# write emf
emf(file = here("figures","gap_decomposition_2010-2015.emf"), width = 9, height = 6)
fig_gap_yearly + geom_bar(stat = "identity") + coord_flip() + xlab("") + ylab("USD bil.") + scale_fill_manual(values = cpal, name = "") +
                 scale_x_continuous(breaks=c(2010:2015), labels = c("2010","2011","2012","2013","2014","2015")) + theme_bw() + theme(legend.position="bottom")
dev.off()

cairo_ps(file = here("figures","gap_decomposition_2010-2015.eps"), width = 9, height = 6)
fig_gap_yearly + geom_bar(stat = "identity") + coord_flip() + xlab("") + ylab("USD bil.") + scale_fill_manual(values = cpal, name = "") +
                 scale_x_continuous(breaks=c(2010:2015), labels = c("2010","2011","2012","2013","2014","2015")) + theme_bw() + theme(legend.position="bottom")
dev.off()
...
gap_yearly[, trade.value.mismatch.tariff.share := trade.value.mismatch.tariff/trade.gap*100]
...
gap_yearly_shares <- gap_yearly[, j=.(year, trade.value.mismatch.costs.share, trade.value.mismatch.extreme.p.share,
                                      trade.value.mismatch.tariff.share,
...
gap_yearly_shares[component == "trade.value.mismatch.tariff.share", component:="Tariff costs"]
...
# make component into factor - ordered
gap_yearly_shares[, component := factor(component, c("trade.value.all","trade.gap","Country misclassification","Product misclassification","Unmatched trade","Abnormal prices","Trade costs",'Tariff costs',"Residual"),
                                   ordered = T)]
...
# write emf
emf(file = here("figures","gap_shares_2010-2015.emf"), width = 9, height = 6)
fig_gap_yearly_shares + geom_bar(position = "fill", stat = "identity") +  coord_flip() + xlab("") + ylab("") + scale_fill_manual(values = cpal, name = "") +
                 scale_x_continuous(breaks=c(2010:2015), labels = c("2010","2011","2012","2013","2014","2015")) + theme_bw() + theme(legend.position="bottom")
dev.off()

cairo_ps(file = here("figures","gap_shares_2010-2015.eps"), width = 9, height = 6)
fig_gap_yearly_shares + geom_bar(position = "fill", stat = "identity") +  coord_flip() + xlab("") + ylab("%") + scale_fill_manual(values = cpal, name = "") +
                 scale_x_continuous(breaks=c(2010:2015), labels = c("2010","2011","2012","2013","2014","2015")) + theme_bw() + theme(legend.position="bottom")
dev.off()
...
# write emf
emf(file = here("figures","gap_region_2015.emf"), width = 9, height = 6)
fig_gap_region + geom_bar(stat = "identity") + coord_flip() + xlab("") + ylab("USD bil.") + scale_fill_manual(values = cpal, name = "") + theme_bw() + theme(legend.position="bottom")
dev.off()

cairo_ps(file = here("figures","gap_region_2015.eps"), width = 9, height = 6)
fig_gap_region + geom_bar(stat = "identity") + coord_flip() + xlab("") + ylab("USD bil.") + scale_fill_manual(values = cpal, name = "") + theme_bw() + theme(legend.position="bottom")
dev.off()
...
# write emf
emf(file = here("figures","gap_igroup_2015.emf"), width = 9, height = 6)
fig_gap_igroup + geom_bar(stat = "identity") + coord_flip() + xlab("") + ylab("USD bil.") + scale_fill_manual(values = cpal, name = "") + theme_bw() + theme(legend.position="bottom")
dev.off()

cairo_ps(file = here("figures","gap_igroup_2015.eps"), width = 9, height = 6)
fig_gap_igroup + geom_bar(stat = "identity") + coord_flip() + xlab("") + ylab("USD bil.") + scale_fill_manual(values = cpal, name = "") + theme_bw() + theme(legend.position="bottom")
dev.off()
...
gap_yearly[, trade.value.mismatch.tariff.share := trade.value.mismatch.tariff/ngdp*100]
...
gap_yearly_shares <- gap_yearly[, j=.(year, i.group, trade.value.mismatch.costs.share, trade.value.mismatch.tariff.share,
                                      trade.value.mismatch.extreme.p.share, trade.value.mismatch.residual.share,
                                      trade.value.unmatched.all.share, trade.value.unmatched.all.tt.share,
                                      trade.value.unmatched.all.hs4.share)]
...
# make component into factor - ordered
gap_yearly_shares[, component := factor(component, c("Country misclassification","Product misclassification","Unmatched trade","Abnormal prices", "Trade costs", "Tariff costs", "Residual"),
                    ordered = T)]
...
# write emf
emf(file = here("figures","gap_igroup_ngdp_share_2015.emf"), width = 9, height = 6)
fig_gap_igroup + geom_bar(stat = "identity") + coord_flip() + xlab("") + ylab("Share of GDP (%)") + scale_fill_manual(values = cpal, name = "") + theme_bw() + theme(legend.position="bottom")
dev.off()

cairo_ps(file = here("figures","gap_igroup_ngdp_share_2015.eps"), width = 9, height = 6)
fig_gap_igroup + geom_bar(stat = "identity") + coord_flip() + xlab("") + ylab("Share of GDP (%)") + scale_fill_manual(values = cpal, name = "") + theme_bw() + theme(legend.position="bottom")
dev.off()
...
gap_yearly_shares <- gap_yearly[, j=.(year, region, trade.value.mismatch.costs.share, trade.value.mismatch.tariff.share, trade.value.mismatch.extreme.p.share,
                                      trade.value.mismatch.residual.share, trade.value.unmatched.all.share,
                                      trade.value.unmatched.all.tt.share, trade.value.unmatched.all.hs4.share)]
...
# write emf
emf(file = here("figures","gap_reg_ngdp_share_2015.emf"), width = 9, height = 6)
fig_gap_reg_gdp + geom_bar(stat = "identity") + coord_flip() + xlab("") + ylab("Share of GDP (%)") + scale_fill_manual(values = cpal, name = "") + theme_bw() + theme(legend.position="bottom")
dev.off()

cairo_ps(file = here("figures","gap_reg_ngdp_share_2015.eps"), width = 9, height = 6)
fig_gap_reg_gdp + geom_bar(stat = "identity") + coord_flip() + xlab("") + ylab("Share of GDP (%)") + scale_fill_manual(values = cpal, name = "") + theme_bw() + theme(legend.position="bottom")
dev.off()
...
gap_yearly_shares <- gap_yearly[, j=.(year, i.group, trade.value.mismatch.costs.share, trade.value.mismatch.tariff.share,
                                      trade.value.mismatch.extreme.p.share, trade.value.mismatch.residual.share,
                                      trade.value.unmatched.all.share, trade.value.unmatched.all.tt.share, trade.value.unmatched.all.hs4.share)]
...
# write emf
emf(file = here("figures","gap_igroup_gap_share_2015.emf"), width = 9, height = 6)
fig_gap_igroup + geom_bar(position="stack", stat = "identity") + coord_flip() + xlab("") + ylab("Share of overall trade gap") + scale_fill_manual(values = cpal, name = "") + theme_bw() + theme(legend.position="bottom")
dev.off()

cairo_ps(file = here("figures","gap_igroup_gap_share_2015.eps"), width = 9, height = 6)
fig_gap_igroup + geom_bar(position="stack", stat = "identity") + coord_flip() + xlab("") + ylab("Share of overall trade gap") + scale_fill_manual(values = cpal, name = "") + theme_bw() + theme(legend.position="bottom")
dev.off()